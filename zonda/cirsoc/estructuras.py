...
import cirsoc.geometria as ge
from cirsoc import cp
from cirsoc.factores import Topografia, Rafaga
import cirsoc.presiones as pr
from cirsoc.reportes import Reporte
...
class Cartel:
    ...
    def reporte(self):
        return Reporte('cartel.html', estructura=self)
...
class CubiertaAislada:
    ...
    def reporte(self):
        return Reporte('aislada.html', estructura=self)
...
class Edificio:
    ...
    def reporte(self):
        return Reporte('edificio.html', estructura=self)
